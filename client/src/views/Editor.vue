...
import Sortable from '../components/editor/Sortable.vue'
import CreateField from '../components/editor/CreateField.vue'
...
<template>
    ...
    <div class="dashboard">
        ...
        <div class="info ">
            <div class="card ">
                <ClickInput label="Name:" placeholder="trivia name" :text="gameName" @input-submit="updateGameName" />
            </div>
            <div class="card ">
